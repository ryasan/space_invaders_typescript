...
export const randomInt = (min: number, max: number, positive?: boolean | undefined) => {
  let num;
...
class GameOver extends HTMLElement {
  ...
  constructor(isWinner: boolean, game: Game) {
    ...
    this.playAgainBtn = this.querySelector('#play-again-btn') as HTMLElement;
...
export class Game extends HTMLElement {
  ...
  constructor() {
    ...
    this.innerHTML = `
      ...
      <canvas id="canvas" width="${this.getSize.w}" height="${this.getSize.h}"> </canvas>
    `;
