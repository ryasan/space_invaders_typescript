...
export default class Player extends Entity {
  ...
  constructor(destination: Destination) {
    ...
    this.playerDeath.subscribe(this.destroy, this.playerDeath.unsubscribeAll);
  }
  ...
  update = () => {
    ...
    if (this.keyboard.pressing['ArrowRight'] && this.destination.x < this.game.canvas.width - ship.w) {
      this.destination.x += 5;
    }
